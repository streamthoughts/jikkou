...
public class V1KafkaQuotaList implements HasMetadata, HasSpec<V1KafkaQuotaSpec> , Resource
{
     ...
     */
    @JsonProperty("spec")
    private io.streamthoughts.jikkou.kafka.models.V1KafkaQuotaSpec spec;
    ...
    public V1KafkaQuotaList(String apiVersion, String kind, ObjectMeta metadata, ObjectTemplate template, io.streamthoughts.jikkou.kafka.models.V1KafkaQuotaSpec spec) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.streamthoughts.jikkou.kafka.models.V1KafkaQuotaSpec getSpec() {
        return spec;
    }
