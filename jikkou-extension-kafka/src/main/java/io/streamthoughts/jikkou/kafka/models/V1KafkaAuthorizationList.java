...
public class V1KafkaAuthorizationList implements HasMetadata, HasSpec<V1KafkaAuthorizationSpec> , Resource
{
     ...
     */
    @JsonProperty("kind")
    private String kind = "KafkaAuthorizationList";
    ...
    private io.streamthoughts.jikkou.kafka.models.V1KafkaAuthorizationSpec spec;

    /**
     * No args constructor for use in serialization
     * 
     */
    public V1KafkaAuthorizationList() {
    }
    ...
    public V1KafkaAuthorizationList(String apiVersion, String kind, ObjectMeta metadata, ObjectTemplate template, io.streamthoughts.jikkou.kafka.models.V1KafkaAuthorizationSpec spec) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.streamthoughts.jikkou.kafka.models.V1KafkaAuthorizationSpec getSpec() {
        return spec;
    }
    ...
    public String toString() {
        ...
        sb.append(V1KafkaAuthorizationList.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof V1KafkaAuthorizationList) == false) {
            return false;
        }
        V1KafkaAuthorizationList rhs = ((V1KafkaAuthorizationList) other);
