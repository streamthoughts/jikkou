...
public class V1KafkaTableRecord implements HasMetadata, HasSpec<V1KafkaTableRecordSpec> , Resource
{
     ...
     */
    @JsonProperty("spec")
    private io.streamthoughts.jikkou.kafka.models.V1KafkaTableRecordSpec spec;

    /**
     * No args constructor for use in serialization
     * 
     */
    public V1KafkaTableRecord() {
    }
    ...
    public V1KafkaTableRecord(String apiVersion, String kind, ObjectMeta metadata, ObjectTemplate template, io.streamthoughts.jikkou.kafka.models.V1KafkaTableRecordSpec spec) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.streamthoughts.jikkou.kafka.models.V1KafkaTableRecordSpec getSpec() {
        return spec;
    }
    ...
    public String toString() {
        ...
        sb.append(V1KafkaTableRecord.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof V1KafkaTableRecord) == false) {
            return false;
        }
        V1KafkaTableRecord rhs = ((V1KafkaTableRecord) other);
