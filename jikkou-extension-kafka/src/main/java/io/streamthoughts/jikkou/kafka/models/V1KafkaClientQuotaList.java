...
public class V1KafkaClientQuotaList implements ResourceListObject<V1KafkaClientQuota>
{
    ...
    @JsonProperty("kind")
    @Builder.Default
    private String kind = "KafkaClientQuotaList";
    ...
    @JsonProperty("items")
    @Singular
    private List<io.streamthoughts.jikkou.kafka.models.V1KafkaClientQuota> items = new ArrayList<io.streamthoughts.jikkou.kafka.models.V1KafkaClientQuota>();
    ...
    public V1KafkaClientQuotaList(String apiVersion, String kind, ObjectMeta metadata, ObjectTemplate template, List<io.streamthoughts.jikkou.kafka.models.V1KafkaClientQuota> items) {
        super();
     ...
     */
    @JsonProperty("items")
    public List<io.streamthoughts.jikkou.kafka.models.V1KafkaClientQuota> getItems() {
        return items;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof V1KafkaClientQuotaList) == false) {
            return false;
        }
        V1KafkaClientQuotaList rhs = ((V1KafkaClientQuotaList) other);
