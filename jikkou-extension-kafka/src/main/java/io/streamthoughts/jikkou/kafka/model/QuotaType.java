...
public enum QuotaType {
    ...
    /**
     * Helper method to get a {@link QuotaType} from the given map of entities.
     *
     * @param entries the quota entities.
     * @return the {@link QuotaType}.
     */
    public static QuotaType from(@NotNull final Map<String, String> entries) {
