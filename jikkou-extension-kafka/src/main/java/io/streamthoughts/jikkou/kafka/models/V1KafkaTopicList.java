...
public class V1KafkaTopicList implements HasMetadata, HasSpec<V1KafkaTopicSpec> , Resource
{
    ...
    public V1KafkaTopicList(String apiVersion, String kind, ObjectMeta metadata, ObjectTemplate template, io.streamthoughts.jikkou.kafka.models.V1KafkaTopicSpec spec) {
        super();
