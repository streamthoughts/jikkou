...
public class V1KafkaTopicList implements ResourceListObject<V1KafkaTopic>
{
     ...
     */
    @JsonProperty("kind")
    private String kind = "KafkaTopicList";
    ...
    @JsonProperty("items")
    @Singular
    private List<io.streamthoughts.jikkou.kafka.models.V1KafkaTopic> items = new ArrayList<io.streamthoughts.jikkou.kafka.models.V1KafkaTopic>();

    /**
     * No args constructor for use in serialization
     * 
     */
    public V1KafkaTopicList() {
    }
    ...
    public V1KafkaTopicList(String apiVersion, String kind, ObjectMeta metadata, ObjectTemplate template, List<io.streamthoughts.jikkou.kafka.models.V1KafkaTopic> items) {
        super();
     ...
     */
    @JsonProperty("items")
    public List<io.streamthoughts.jikkou.kafka.models.V1KafkaTopic> getItems() {
        return items;
    }
    ...
    public String toString() {
        ...
        sb.append(V1KafkaTopicList.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof V1KafkaTopicList) == false) {
            return false;
        }
        V1KafkaTopicList rhs = ((V1KafkaTopicList) other);
