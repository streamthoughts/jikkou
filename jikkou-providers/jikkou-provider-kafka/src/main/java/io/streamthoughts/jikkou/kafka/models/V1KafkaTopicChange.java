...
public class V1KafkaTopicChange implements HasMetadataChange<TopicChange> , Resource
{
    ...
    public V1KafkaTopicChange(String apiVersion, String kind, ObjectMeta metadata, TopicChange change) {
        super();
