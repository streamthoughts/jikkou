...
/**
 * Immutable processor to be used for both transforming and validating a resource specification file
 * before being applied on a target cluster.
 *
...
public interface Processor<T extends Processor<T>> {
     ...
     */
    @NotNull T withTransformation(@NotNull final Supplier<Transformation> transformation);
    ...
    default @NotNull T withTransformations(@NotNull final List<Supplier<Transformation>> transformations) {
     ...
     * @return  a new immutable {@link Processor}.
     */
    @NotNull T withValidation(@NotNull final Supplier<Validation> validation);
     ...
     */
    @SuppressWarnings("unchecked")
    default @NotNull T withValidations(@NotNull final List<Supplier<Validation>> validations) {
