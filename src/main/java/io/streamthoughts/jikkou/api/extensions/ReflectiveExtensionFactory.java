...
public class ReflectiveExtensionFactory extends DefaultExtensionFactory {
     ...
     */
    @Override
    public <T extends Extension> T getExtension(@NotNull final String type, @NotNull final JikkouConfig config) {
     ...
     */
    @Override
    public <T extends Extension> Collection<T> getAllExtensions(@NotNull final Class<T> type, @NotNull final JikkouConfig config) {
        mayScanForExtensions();
