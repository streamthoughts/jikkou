...
public class ExecuteServerCommand implements ClusterCommand<Collection<OperationResult<TopicResource>>> {
    ...
    /**
     * Creates a new {@link ExecuteServerCommand} instance.
     * @param client
     */
    public ExecuteServerCommand(final AdminClient client) {
        this.client = client;
    }
