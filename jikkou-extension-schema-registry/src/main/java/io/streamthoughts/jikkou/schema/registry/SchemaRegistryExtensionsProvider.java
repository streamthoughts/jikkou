...
public class SchemaRegistryExtensionsProvider implements ExtensionProvider {
    ...
    public void registerExtensions(@NotNull ExtensionFactory factory,
        ...
        factory.register(SchemaRegistryCollector.class);
        factory.register(SchemaRegistryController.class);
        factory.register(AvroSchemaValidation.class);
        factory.register(SchemaCompatibilityValidation.class);
        factory.register(NormalizeSubjectSchemaTransformation.class);
    }
}
