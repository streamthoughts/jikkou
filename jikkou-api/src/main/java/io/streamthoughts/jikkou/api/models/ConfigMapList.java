...
public class ConfigMapList implements ResourceListObject<ConfigMap>
{
    ...
    @JsonProperty("items")
    @Singular
    private List<io.streamthoughts.jikkou.api.models.ConfigMap> items = new ArrayList<io.streamthoughts.jikkou.api.models.ConfigMap>();
    ...
    public ConfigMapList(String apiVersion, String kind, ObjectMeta metadata, ObjectTemplate template, List<io.streamthoughts.jikkou.api.models.ConfigMap> items) {
        super();
     ...
     */
    @JsonProperty("items")
    public List<io.streamthoughts.jikkou.api.models.ConfigMap> getItems() {
        return items;
    }
