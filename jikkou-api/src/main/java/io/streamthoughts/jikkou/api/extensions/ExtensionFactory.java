...
public interface ExtensionFactory {
    ...
    default <T extends Extension> Collection<T> getAllExtensions(final Class<T> type) {
        return getAllExtensions(type, Configuration.empty());
    }
     ...
     * @param <T>   the extension-type.
     */
    <T extends Extension> Collection<T> getAllExtensions(final Class<T> type, final Configuration config);
     ...
     * @return  the list of {@link ExtensionDescriptor}.
     */
    <T extends Extension> Collection<ExtensionDescriptor<T>> allExtensionsDescriptorForType(@NotNull final Class<T> type) ;
