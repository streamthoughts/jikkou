 ...
 */
package io.streamthoughts.jikkou.api.config.internals;
...
public class TypeConverter implements Serializable {
    ...
    public static Boolean getBool(final Object value) throws IllegalArgumentException {
        ...
        if (result == null) {
            throw new ConfigException(String.format("Cannot parse boolean content from \"%s\"", value));
        }
        return result;
    }
    ...
    public static Date getDate(final Object value) throws IllegalArgumentException {
        ...
        throw new ConfigException(String.format("Cannot parse Date content from \"%s\"", value));
    }
    ...
    public static byte[] getBytes(final Object value) {
        ...
        throw new ConfigException(String.format("Cannot parse byte[] from \"%s\"", value));
    }
    ...
    public static BigDecimal getDecimal(final Object value) {
        ...
        return getBigDecimal(value)
                .orElseThrow(() ->
                        new ConfigException(String.format("Cannot parse decimal content from \"%s\"", value))
                );
    }
