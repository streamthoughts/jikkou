...
import static io.jikkou.runtime.configurator.ExtensionConfigEntry.DEFAULT_CONFIG;
import static io.jikkou.runtime.configurator.ExtensionConfigEntry.ENABLED_CONFIG;
...
class ProviderApiConfiguratorTest {
    ...
    void shouldGroupEntriesByType() {
        // Given
        String providerType = "io.jikkou.TestProvider";
    ...
    void shouldGroupMultipleProviderTypes() {
        // Given
        String providerType1 = "io.jikkou.TestProvider1";
        String providerType2 = "io.jikkou.TestProvider2";
