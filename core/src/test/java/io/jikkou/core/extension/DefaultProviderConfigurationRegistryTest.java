...
class DefaultProviderConfigurationRegistryTest {
    ...
    private static final String PROVIDER_TYPE_KAFKA = "io.jikkou.kafka.KafkaExtensionProvider";
    private static final String PROVIDER_TYPE_SCHEMA_REGISTRY = "io.jikkou.schema.registry.SchemaRegistryExtensionProvider";
