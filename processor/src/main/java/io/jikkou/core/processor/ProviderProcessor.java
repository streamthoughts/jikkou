...
import io.jikkou.common.utils.Exceptions;
...
public class ProviderProcessor extends AbstractProcessor {
    ...
    public static final String PROVIDER_RESOURCE_FILE = ServicesFiles.getPath(io.jikkou.spi.ExtensionProvider.class.getCanonicalName());
     ...
     * {@link io.jikkou.spi.ExtensionProvider} interface.
     */
     ...
     *      </ul>
     *
     * <li> Create a file named {@code META-INF/services/io.jikkou.spi.ExtensionProvider}
    ...
    private void processAnnotations(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        Element extensionInterface = elementUtils.getTypeElement(io.jikkou.spi.ExtensionProvider.class.getCanonicalName());
     ...
     * {@code io.jikkou.Foo$Bar}, instead of {@code io.jikkou.Foo.Bar}.
     */
