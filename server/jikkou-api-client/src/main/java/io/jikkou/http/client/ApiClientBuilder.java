...
import static io.jikkou.http.client.Config.DEFAULT_FALLBACK_HOST;
import static io.jikkou.http.client.Config.DEFAULT_FALLBACK_PORT;

import io.jikkou.core.io.Jackson;
import io.jikkou.http.client.exception.JikkouApiClientException;
import io.jikkou.http.client.interceptors.ClientLoggingInterceptor;
import io.jikkou.http.client.security.SSLContextFactory;
import io.jikkou.http.client.security.SSLUtils;
import io.jikkou.http.client.serdes.JSON;
