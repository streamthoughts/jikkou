...
public class V1KafkaBroker implements HasMetadata, HasSpec<V1KafkaBrokersSpec>
{
     ...
     */
    @JsonProperty("spec")
    private io.jikkou.kafka.models.V1KafkaBrokersSpec spec;
    ...
    public V1KafkaBroker(String apiVersion, String kind, ObjectMeta metadata, ObjectTemplate template, io.jikkou.kafka.models.V1KafkaBrokersSpec spec) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.jikkou.kafka.models.V1KafkaBrokersSpec getSpec() {
        return spec;
    }
