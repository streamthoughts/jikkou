 ...
 */
@Title("Enforce min topic retention")
@Description("Enforces a minimum retention period in milliseconds on all Kafka topic resources.")
...
public class KafkaTopicMinRetentionMsTransformation implements Transformation<V1KafkaTopic> {
    ...
    public static final ConfigProperty<Long> MIN_RETENTIONS_MS_CONFIG = ConfigProperty
            ...
            .displayName("Min Retention Ms")
            .description("The minimum retention period in milliseconds allowed for a Kafka topic.");
