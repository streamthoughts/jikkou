...
@Example(
        ...
        code = {"""
                ...
                - name: "topicMustHavePartitionsEqualsOrLessThanFifty"
                  type: "io.jikkou.kafka.validation.TopicMaxNumPartitionsValidation"
                  priority: 100
                  config:
...
public final class TopicMaxNumPartitionsValidation extends TopicValidation {
    ...
    public void init(@NotNull final ExtensionContext context) {
        super.init(context);
        maxNumPartitions = VALIDATION_TOPIC_MAX_NUM_PARTITIONS_CONFIG.getOptional(context.configuration())
