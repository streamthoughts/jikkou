...
public class V1KafkaPrincipalAuthorization implements HasMetadata, HasSpec<V1KafkaPrincipalAuthorizationSpec> , Resource
{
    ...
    private io.jikkou.kafka.models.V1KafkaPrincipalAuthorizationSpec spec;
    ...
    public V1KafkaPrincipalAuthorization(String apiVersion, String kind, ObjectMeta metadata, ObjectTemplate template, io.jikkou.kafka.models.V1KafkaPrincipalAuthorizationSpec spec) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.jikkou.kafka.models.V1KafkaPrincipalAuthorizationSpec getSpec() {
        return spec;
    }
