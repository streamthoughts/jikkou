...
public class V1KafkaClientQuota implements HasMetadata, HasSpec<V1KafkaClientQuotaSpec> , Resource
{
    ...
    private io.jikkou.kafka.models.V1KafkaClientQuotaSpec spec;
    ...
    public V1KafkaClientQuota(String apiVersion, String kind, ObjectMeta metadata, ObjectTemplate template, io.jikkou.kafka.models.V1KafkaClientQuotaSpec spec) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.jikkou.kafka.models.V1KafkaClientQuotaSpec getSpec() {
        return spec;
    }
