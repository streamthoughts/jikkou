...
import io.jikkou.core.models.ObjectTemplate;
...
public class V1KafkaTableRecord implements HasMetadata, HasSpec<V1KafkaTableRecordSpec> , Resource
{
     ...
     */
    @JsonProperty("spec")
    private io.jikkou.kafka.models.V1KafkaTableRecordSpec spec;
    ...
    public V1KafkaTableRecord(String apiVersion, String kind, ObjectMeta metadata, ObjectTemplate template, io.jikkou.kafka.models.V1KafkaTableRecordSpec spec) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.jikkou.kafka.models.V1KafkaTableRecordSpec getSpec() {
        return spec;
    }
