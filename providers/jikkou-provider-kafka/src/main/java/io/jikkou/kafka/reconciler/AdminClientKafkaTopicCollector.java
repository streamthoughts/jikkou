...
import static io.jikkou.kafka.reconciler.KafkaConfigsConfig.DEFAULT_CONFIGS;
...
import io.jikkou.kafka.internals.KafkaConfigPredicate;
...
import io.jikkou.kafka.reconciler.service.KafkaTopicService;
...
@Title("Collect Kafka topics")
@Description("Collects all Kafka topic resources from a Kafka cluster using the AdminClient API.")
