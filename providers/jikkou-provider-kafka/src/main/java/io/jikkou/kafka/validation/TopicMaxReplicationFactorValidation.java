...
import io.jikkou.kafka.internals.KafkaTopics;
...
@Example(
        ...
        code = {"""
                ...
                - name: "topicMustHaveReplicasEqualsOrLessThanThree"
                  type: "io.jikkou.kafka.validation.TopicMaxReplicationFactorValidation"
                  priority: 100
                  config:
...
public final class TopicMaxReplicationFactorValidation extends TopicValidation {
    ...
    public void init(@NotNull final ExtensionContext context) {
        super.init(context);
        maxReplicationFactor = VALIDATION_TOPIC_MAX_REPLICATION_FACTOR_CONFIG.getOptional(context.configuration())
