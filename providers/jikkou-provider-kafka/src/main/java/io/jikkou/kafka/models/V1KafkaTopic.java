...
@Names(singular = "kafkatopic", plural = "kafkatopics", local = "topics", shortNames = {
    "kt"
})
@Verbs({
    Verb.LIST,
...
public class V1KafkaTopic implements HasMetadata, HasSpec<V1KafkaTopicSpec> , Resource
{
     ...
     */
    @JsonProperty("spec")
    private io.jikkou.kafka.models.V1KafkaTopicSpec spec;
    @JsonProperty("status")
    ...
    public V1KafkaTopic(String apiVersion, String kind, ObjectMeta metadata, ObjectTemplate template, io.jikkou.kafka.models.V1KafkaTopicSpec spec, V1KafkaTopicStatus status) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.jikkou.kafka.models.V1KafkaTopicSpec getSpec() {
        return spec;
    }
