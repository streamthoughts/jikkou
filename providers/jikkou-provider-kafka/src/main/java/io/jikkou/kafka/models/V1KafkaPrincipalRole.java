...
import io.jikkou.core.annotation.Transient;
...
public class V1KafkaPrincipalRole implements HasMetadata, HasSpec<V1KafkaPrincipalRoleSpec> , Resource
{
    ...
    private io.jikkou.kafka.models.V1KafkaPrincipalRoleSpec spec;
    ...
    public V1KafkaPrincipalRole(String apiVersion, String kind, ObjectMeta metadata, ObjectTemplate template, io.jikkou.kafka.models.V1KafkaPrincipalRoleSpec spec) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.jikkou.kafka.models.V1KafkaPrincipalRoleSpec getSpec() {
        return spec;
    }
