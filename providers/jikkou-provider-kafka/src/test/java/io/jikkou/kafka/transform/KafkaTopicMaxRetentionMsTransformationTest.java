...
import static io.jikkou.kafka.transform.KafkaTopicMaxRetentionMsTransformation.MAX_RETENTIONS_MS_CONFIG;
...
class KafkaTopicMaxRetentionMsTransformationTest {
    ...
    void beforeEach() {
        ...
        Mockito.when(context.configuration()).thenReturn(MAX_RETENTIONS_MS_CONFIG.asConfiguration(MAX_VALUE));
