 ...
 */
package io.jikkou.kafka.connect.api.data;
 ...
 * @see io.jikkou.kafka.connect.api.KafkaConnectApi#getConnector(String)
 * @see io.jikkou.kafka.connect.api.KafkaConnectApi#createOrUpdateConnector(String, Map)
 */
@Reflectable
