 ...
 */
package io.jikkou.kafka.connect.models;
...
public class V1KafkaConnector implements HasMetadata, HasSpec<V1KafkaConnectorSpec> , Resource
{
     ...
     */
    @JsonProperty("spec")
    private io.jikkou.kafka.connect.models.V1KafkaConnectorSpec spec;
    @JsonProperty("status")
    ...
    public V1KafkaConnector(String apiVersion, String kind, ObjectMeta metadata, io.jikkou.kafka.connect.models.V1KafkaConnectorSpec spec, V1KafkaConnectorStatus status) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.jikkou.kafka.connect.models.V1KafkaConnectorSpec getSpec() {
        return spec;
    }
