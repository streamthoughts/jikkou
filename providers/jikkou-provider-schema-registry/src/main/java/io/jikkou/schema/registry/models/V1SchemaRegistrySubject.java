 ...
 */
package io.jikkou.schema.registry.models;
...
public class V1SchemaRegistrySubject implements HasMetadata, HasSpec<V1SchemaRegistrySubjectSpec> , Resource
{
     ...
     */
    @JsonProperty("spec")
    private io.jikkou.schema.registry.models.V1SchemaRegistrySubjectSpec spec;
    ...
    public V1SchemaRegistrySubject(String apiVersion, String kind, ObjectMeta metadata, io.jikkou.schema.registry.models.V1SchemaRegistrySubjectSpec spec) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.jikkou.schema.registry.models.V1SchemaRegistrySubjectSpec getSpec() {
        return spec;
    }
