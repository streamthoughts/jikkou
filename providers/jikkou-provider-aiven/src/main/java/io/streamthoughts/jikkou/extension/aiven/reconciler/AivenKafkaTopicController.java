...
import io.streamthoughts.jikkou.kafka.reconciler.AdminClientKafkaConfigs;
...
@SupportedResource(apiVersion = ApiVersions.KAFKA_AIVEN_V1BETA2, kind = "KafkaTopicChange")
@SupportedResource(apiVersion = ApiVersions.KAFKA_AIVEN_V1BETA2, kind = "KafkaTopic")
