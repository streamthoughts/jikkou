...
public class V1KafkaTopicAclEntry implements HasMetadata, HasSpec<V1KafkaTopicAclEntrySpec> , Resource
{
     ...
     */
    @JsonProperty("spec")
    private io.jikkou.extension.aiven.models.V1KafkaTopicAclEntrySpec spec;
    ...
    public V1KafkaTopicAclEntry(String apiVersion, String kind, ObjectMeta metadata, io.jikkou.extension.aiven.models.V1KafkaTopicAclEntrySpec spec) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.jikkou.extension.aiven.models.V1KafkaTopicAclEntrySpec getSpec() {
        return spec;
    }
