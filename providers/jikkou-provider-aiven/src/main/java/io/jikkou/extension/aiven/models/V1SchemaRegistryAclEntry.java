...
public class V1SchemaRegistryAclEntry implements HasMetadata, HasSpec<V1SchemaRegistryAclEntrySpec> , Resource
{
     ...
     */
    @JsonProperty("spec")
    private io.jikkou.extension.aiven.models.V1SchemaRegistryAclEntrySpec spec;
    ...
    public V1SchemaRegistryAclEntry(String apiVersion, String kind, ObjectMeta metadata, io.jikkou.extension.aiven.models.V1SchemaRegistryAclEntrySpec spec) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.jikkou.extension.aiven.models.V1SchemaRegistryAclEntrySpec getSpec() {
        return spec;
    }
