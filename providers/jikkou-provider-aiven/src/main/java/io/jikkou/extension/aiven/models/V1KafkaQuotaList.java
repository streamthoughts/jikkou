 ...
 */
package io.jikkou.extension.aiven.models;
...
public class V1KafkaQuotaList implements ResourceList<V1KafkaQuota>
{
    ...
    @JsonProperty("items")
    @Singular
    private List<io.jikkou.extension.aiven.models.V1KafkaQuota> items = new ArrayList<io.jikkou.extension.aiven.models.V1KafkaQuota>();
    ...
    public V1KafkaQuotaList(String apiVersion, String kind, ObjectMeta metadata, List<io.jikkou.extension.aiven.models.V1KafkaQuota> items) {
        super();
    ...
    @JsonProperty("items")
    public List<io.jikkou.extension.aiven.models.V1KafkaQuota> getItems() {
        return items;
    }
