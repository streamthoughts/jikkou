...
import io.jikkou.extension.aiven.api.data.CompatibilityCheckResponse;
import io.jikkou.extension.aiven.api.data.KafkaAclEntry;
import io.jikkou.extension.aiven.api.data.KafkaQuotaEntry;
import io.jikkou.extension.aiven.api.data.KafkaTopicInfoCreate;
import io.jikkou.extension.aiven.api.data.KafkaTopicInfoResponse;
import io.jikkou.extension.aiven.api.data.KafkaTopicInfoUpdate;
...
import io.jikkou.extension.aiven.api.data.ServiceInformationResponse;
import io.jikkou.extension.aiven.api.data.SubjectSchemaConfigurationResponse;
import io.jikkou.extension.aiven.api.data.SubjectSchemaRegistrationResponse;
import io.jikkou.extension.aiven.api.data.SubjectSchemaVersionResponse;
import io.jikkou.schema.registry.api.data.CompatibilityObject;
import io.jikkou.schema.registry.api.data.SubjectSchemaRegistration;
