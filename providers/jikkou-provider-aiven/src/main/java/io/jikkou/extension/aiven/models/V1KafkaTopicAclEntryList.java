...
public class V1KafkaTopicAclEntryList implements ResourceList<V1KafkaTopicAclEntry>
{
    ...
    @JsonProperty("items")
    @Singular
    private List<io.jikkou.extension.aiven.models.V1KafkaTopicAclEntry> items = new ArrayList<io.jikkou.extension.aiven.models.V1KafkaTopicAclEntry>();
    ...
    public V1KafkaTopicAclEntryList(String apiVersion, String kind, ObjectMeta metadata, List<io.jikkou.extension.aiven.models.V1KafkaTopicAclEntry> items) {
        super();
    ...
    @JsonProperty("items")
    public List<io.jikkou.extension.aiven.models.V1KafkaTopicAclEntry> getItems() {
        return items;
    }
