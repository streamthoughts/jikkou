...
@Names(singular = "avn-kafkaquota", plural = "avn-kafkaquotas", local = "kafka-quotas", shortNames = {
    "avnkq"
})
@Verbs({
    Verb.APPLY,
...
public class V1KafkaQuota implements HasMetadata, HasSpec<V1KafkaQuotaSpec> , Resource
{
     ...
     */
    @JsonProperty("spec")
    private io.jikkou.extension.aiven.models.V1KafkaQuotaSpec spec;
    ...
    public V1KafkaQuota(String apiVersion, String kind, ObjectMeta metadata, io.jikkou.extension.aiven.models.V1KafkaQuotaSpec spec) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.jikkou.extension.aiven.models.V1KafkaQuotaSpec getSpec() {
        return spec;
    }
