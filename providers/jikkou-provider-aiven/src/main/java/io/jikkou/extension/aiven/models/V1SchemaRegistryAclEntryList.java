...
public class V1SchemaRegistryAclEntryList implements ResourceList<V1SchemaRegistryAclEntry>
{
    ...
    @JsonProperty("items")
    @Singular
    private List<io.jikkou.extension.aiven.models.V1SchemaRegistryAclEntry> items = new ArrayList<io.jikkou.extension.aiven.models.V1SchemaRegistryAclEntry>();
    ...
    public V1SchemaRegistryAclEntryList(String apiVersion, String kind, ObjectMeta metadata, List<io.jikkou.extension.aiven.models.V1SchemaRegistryAclEntry> items) {
        super();
    ...
    @JsonProperty("items")
    public List<io.jikkou.extension.aiven.models.V1SchemaRegistryAclEntry> getItems() {
        return items;
    }
