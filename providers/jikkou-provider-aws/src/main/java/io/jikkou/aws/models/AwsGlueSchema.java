...
public class AwsGlueSchema implements HasMetadata, HasSpec<AwsGlueSchemaSpec> , Resource
{
     ...
     */
    @JsonProperty("spec")
    private io.jikkou.aws.models.AwsGlueSchemaSpec spec;
    ...
    public AwsGlueSchema(String apiVersion, String kind, ObjectMeta metadata, io.jikkou.aws.models.AwsGlueSchemaSpec spec) {
        super();
     ...
     */
    @JsonProperty("spec")
    public io.jikkou.aws.models.AwsGlueSchemaSpec getSpec() {
        return spec;
    }
