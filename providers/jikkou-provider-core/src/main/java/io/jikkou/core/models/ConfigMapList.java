...
public class ConfigMapList implements ResourceList<ConfigMap>
{
    ...
    @JsonProperty("items")
    @Singular
    private List<io.jikkou.core.models.ConfigMap> items = new ArrayList<io.jikkou.core.models.ConfigMap>();
    ...
    public ConfigMapList(String apiVersion, String kind, ObjectMeta metadata, ObjectTemplate template, List<io.jikkou.core.models.ConfigMap> items) {
        super();
     ...
     */
    @JsonProperty("items")
    public List<io.jikkou.core.models.ConfigMap> getItems() {
        return items;
    }
