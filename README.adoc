...
public void setUp() {
    ...
    InputStream topicSpecsInputStream = getClass().getClassLoader().getResourceAsStream("./topics-test.yaml");
    V1SpecFile file = SpecFileLoader.newForYaml().load(topicSpecsInputStream);
    ...
    // (3) Create and configure Adminclient-based ClientKafkaTopicManager
    var manager = new AdminClientKafkaTopicManager();
