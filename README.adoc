...
NOTE: The Jikkou API is still evolving. Future releases may introduce minor breaking changes.

For Gradle::
[source]
----
implementation group: 'io.streamthoughts', name: 'jikkou', version: '0.10.0'
----
